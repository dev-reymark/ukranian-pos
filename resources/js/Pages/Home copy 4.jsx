    ...
    const saveTransaction = async () => {
        ...
        try {
            ...
            if (transactionId) {
                ...
                // const receiptCopyCount = parseInt(
                //     selectedMOP.MOP_ReceiptCopyCount,
                //     10
                // );
                // console.log("Receipt Copy Count:", receiptCopyCount); // Debugging log

                // for (let i = 0; i < receiptCopyCount; i++) {
                //     try {
                //         await handlePrintReceipt(transactionId); // Each call to print receipt
                //     } catch (error) {
